  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved articulo as @articulo" do
        ...
        post :create, {:articulo => { "titulo" => "invalid value" }}, valid_session
        assigns(:articulo).should be_a_new(Articulo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested articulo" do
        ...
        Articulo.any_instance.should_receive(:update).with({ "titulo" => "MyString" })
        put :update, {:id => articulo.to_param, :articulo => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the articulo as @articulo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Articulo.any_instance.stub(:save).and_return(false)
        put :update, {:id => articulo.to_param, :articulo => { "titulo" => "invalid value" }}, valid_session
        assigns(:articulo).should eq(articulo)
      end
